                         ...
                         <div class="card">
                              <div class="card-body">
                                   <div class="dropdown float-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                             <!-- item-->
                                             <a href="<?php echo base_url('todo/acc'); ?>" class="dropdown-item">More
                                                  Info</a>
                         ...
                         <div class="card">
                              <div class="card-body">
                                   <div class="dropdown float-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                             <!-- item-->
                                             <a href="<?php echo base_url('todo/belum'); ?>" class="dropdown-item">More
                                                  Info</a>
                    ...
                    <div class="col-xl-8">
                         <div class="card">
                              <div class="card-body">
                                   ...
                                   <h4 class="header-title mt-0 mb-3">Project Selesai ACC</h4>
