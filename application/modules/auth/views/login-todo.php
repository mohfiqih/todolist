        ...
        <div class="row">
            <div class="img-holder">
                ...
                <div class="info-holder">
                    <img src="assets/backend/images/todo.svg" alt="Politeknik Harapan Bersama" />
                </div>
            </div>
                ...
                <div class="form-content">
                    <div class="form-items">
                        <h3>
                            ...
                            Todo <span style="color: #000000; font-weight: bold"> -</span>
                            <span style="color: blue; font-weight: bold">List</span><br />
                        </h3>
                        <p>
                            <!-- Akses penerimaan mahasiswa baru kampus vokasi raih mimpi lebih
                            pasti.<br /> -->
                        </p>
                        ...
                        <form action="auth/proses" method="POST" autocomplete="off">
                            ...
                            <input class="form-control" type="password" name="password" autocomplete="off" id="password"
